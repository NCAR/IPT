#!/bin/csh 
#
#SBATCH -J Gen_MERRA2_ne0CONUSne30x8_mt12.csh
#SBATCH -n 1
#SBATCH --ntasks-per-node=1
#SBATCH -t 24:00:00
#SBATCH -A P93300643
#SBATCH -p dav
#SBATCH -e Log.Gen_MERRA2_conus.err.%J
#SBATCH -o Log.Gen_MERRA2_conus.out.%J
...
set MYOUTDIR  = '/glade/p/acom/MUSICA/met_data/MERRA2_ne0CONUS30x8_L32/'
...
#------------------------
set CASE                   = 'MERRA2_ne0CONUS30x8_L32'
set DYCORE                 = 'se'
set PRECISION              = 'float'
...
#---------------------------------------------------------
set fname_grid_info        = '/glade/work/rschwant/initials/SE_RR_initials_final_dec2019/opt_se_cslam_nov2019.FCHIST.ne30_ne30_mg17.TS1_pecount2700_CAM_spinup.cam.i.2012-12-01-00000.nc_ne0conus30x8_t12_new.nc'
set fname_phis_output      = '/glade/p/cesmdata/cseg/inputdata/atm/cam/topo/se/ne30x8_CONUS_nc3000_Co060_Fi001_MulG_PF_RR_Nsw042_c200428.nc'
