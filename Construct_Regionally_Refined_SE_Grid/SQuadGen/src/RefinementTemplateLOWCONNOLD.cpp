...
void RefinementTemplateLOWCONNOLD::ApplyStandardTemplate(
	FaceVector & vecFaces,
	NodeVector & vecNodes,
	int ixActiveFace,
	int ixActiveSeg
...
void RefinementTemplateLOWCONNOLD::ApplyInnerCornerTemplate(
	FaceVector & vecFaces,
	NodeVector & vecNodes,
	int ixActiveFace,
	int ixActiveSeg
...
void RefinementTemplateLOWCONNOLD::ApplyOuterCornerTemplate(
	FaceVector & vecFaces,
	NodeVector & vecNodes,
	int ixActiveFace,
	int ixActiveSeg
...
void RefinementTemplateLOWCONNOLD::RefineLocalGrid(
	int nRefineLevel,
	FaceVector & vecFaces,
	NodeVector & vecNodes,
	bool fFirstSegment,
