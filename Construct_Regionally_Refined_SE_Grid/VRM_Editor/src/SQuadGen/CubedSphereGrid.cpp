...
//=============================================================================
void GenerateCSEdgeVertices( int          nRefineLevel,
                             int          ix0         ,
                             int          ix1         ,
                             NodeVector & vecNodes    ,
                             Edge       & edge        ) 
...
//=============================================================================
void GenerateFacesFromQuad( int          nResolution,
                            int          iPanel     ,
                            const Edge & edge0      ,
                            const Edge & edge1      ,
                            const Edge & edge2      ,
...
//=============================================================================
void GenerateCubedSphere( int          nResolution,
                          NodeVector & vecNodes   ,
                          FaceVector & vecFaces   ) 
{
  ...
  //---------------------------
  GenerateFacesFromQuad(nResolution,0,vecEdges[0],vecEdges[ 4],
                                      vecEdges[5],vecEdges[ 8],vecNodes,vecFaces);
  GenerateFacesFromQuad(nResolution,1,vecEdges[1],vecEdges[ 5],
                                      vecEdges[6],vecEdges[ 9],vecNodes,vecFaces);
  GenerateFacesFromQuad(nResolution,2,vecEdges[2],vecEdges[ 6],
                                      vecEdges[7],vecEdges[10],vecNodes,vecFaces);
  GenerateFacesFromQuad(nResolution,3,vecEdges[3],vecEdges[ 7],
                                      vecEdges[4],vecEdges[11],vecNodes,vecFaces);

  // Generate north polar face
  //---------------------------
  GenerateFacesFromQuad(nResolution,4,vecEdges[8],vecEdges[11].Flip(),
                                      vecEdges[9],vecEdges[10].Flip(),vecNodes,vecFaces);

  // Generate south polar face
  //---------------------------
  GenerateFacesFromQuad(nResolution,5,vecEdges[2].Flip(),vecEdges[3],
                                      vecEdges[1].Flip(),vecEdges[0],vecNodes,vecFaces);
}
//=============================================================================
