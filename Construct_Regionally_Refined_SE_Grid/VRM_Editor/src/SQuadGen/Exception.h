  ...
  //====================================================================
{
    ...
    public: //  Maximum buffer size for exception strings.
            //===========================================
            static const int ExceptionBufferSize = 1024;

    public: //  Generic constructor.
            //===========================
            Exception( const char * szFile,
                       unsigned int uiLine) : m_strText("General exception"),
                                              m_strFile(szFile),
                                              m_uiLine (uiLine)
            { }
            ...
            Exception( const char * szFile,
                       unsigned int uiLine,
                       const char * szText, ...) : m_strFile(szFile),m_uiLine(uiLine)
            {
    ...
    public: //  Get a string representation of this exception.
            //=================================================
    ...
    private:
           std::string  m_strText; // A string denoting the error in question.
           std::string  m_strFile; // A string containing the filename where 
                                   //  the exception occurred.
           unsigned int m_uiLine;  // A constant containing the line number 
