...
##--------------------------------------------------------
  ...
  echo " "
  echo "  #--------------------------------------------------------- "
  echo "  # Creating gen_CLMsurfdata scripts in directory: "  $GRID_NAME
  echo "  # "
  echo "  #  Review the variable settings at the begining of the "
  echo "  #  script, set a project number to use, and then run it:"
  echo "  # "
  echo "  #   cheyenne% qsub < genCLMsurfdata_"$GRID_TAG".sh" 
  echo "  # "
  echo "  #--------------------------------------------------------- "
  echo " "
  mkdir -p $GRID_NAME
  sed -e $SEDcmdA -e $SEDcmdT -e $SEDcmdR -e $SEDcmdG -e $SEDcmdS -e $SEDcmdD < ./TEMPLATES/genCLMsurfdata_TEMPLATE.sh >  ./$GRID_NAME/genCLMsurfdata_$GRID_TAG.sh 
