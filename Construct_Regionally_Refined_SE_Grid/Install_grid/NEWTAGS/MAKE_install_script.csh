...
##--------------------------------------------------------
  ...
  echo " "
  echo "  #--------------------------------------------------------- "
  echo "  # Creating the Install script: Install_grid_"$GRID_TAG".csh "
  echo "  # "
  echo "  #  Review the variable settings at the begining of the "
  echo "  #  script and ADD a grid description for the variable GRIDDESC"
  echo "  # "
  echo "  #  Then run the script to install the grid:"
  echo "  # "
  echo "  #   cheyenne% chmod 744 Install_grid_"$GRID_TAG".csh"
  echo "  #   cheyenne% ./Install_grid_"$GRID_TAG".csh"
  echo "  # "
  echo "  #--------------------------------------------------------- "
  echo " "
