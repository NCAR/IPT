...
if [ ${atm_ocn} == 1 ]; then
  ...
  make_map "$focn" "$nocn" "$fatm" "$natm" "$type_ocn" "$type_atm" "aave" "$cdate"
  ...
  echo "----------------------------------------------------------"
  echo ""
  make_map "$focn" "$nocn" "$fatm" "$natm" "$type_ocn" "$type_atm" "blin" "$cdate"
  ...
  echo "----------------------------------------------------------"
  echo ""
  make_map "$fatm" "$natm" "$focn" "$nocn" "$type_atm" "$type_ocn" "aave" "$cdate"
  ...
  echo "----------------------------------------------------------"
  echo ""
  make_map "$fatm" "$natm" "$focn" "$nocn" "$type_atm" "$type_ocn" "blin" "$cdate"
  ...
  echo "----------------------------------------------------------"
  echo ""
  make_map "$fatm" "$natm" "$focn" "$nocn" "$type_atm" "$type_ocn" "patc" "$cdate"
...
if [ $atm_lnd == 1 ]; then
  ...
  make_map "$fatm" "$natm" "$flnd" "$nlnd" "$type_atm" "global" "aave" "$cdate"
  ...
  echo "----------------------------------------------------------"
  echo ""
  make_map "$fatm" "$natm" "$flnd" "$nlnd" "$type_atm" "global" "blin" "$cdate"
  ...
  echo "----------------------------------------------------------"
  echo ""
  make_map "$flnd" "$nlnd" "$fatm" "$natm" "global" "$type_atm" "aave" "$cdate"
...
if [ $ocn_lnd == 1 ]; then
  ...
  make_map "$focn" "$nocn" "$flnd" "$nlnd" "$type_ocn" "global" "aave" "$cdate"
...
if [ $lnd_rtm == 1 ]; then
  ...
  make_map "$flnd" "$nlnd" "$frtm" "$nrtm" "global" "global" "aave" "$cdate"
  ...
  echo "----------------------------------------------------------"
  echo ""
  make_map "$frtm" "$nrtm" "$flnd" "$nlnd" "global" "global" "aave" "$cdate"
...
if [ $lnd_glc == 1 ]; then
  ...
  make_map "$fglc" "$nglc" "$flnd" "$nlnd" "regional" "global" "aave" "$cdate"
  ...
  echo "----------------------------------------------------------"
  echo ""
  make_map "$flnd" "$nlnd" "$fglc" "$nglc" "global" "regional" "aave" "$cdate"
  ...
  echo "----------------------------------------------------------"
  echo ""
  make_map "$flnd" "$nlnd" "$fglc" "$nglc" "global" "regional" "blin" "$cdate"
