...
module spacecurve_mod
  ...
  ! Global Values
  !-------------------
  integer,allocatable:: ordered(:,:)
  integer,allocatable:: dir(:,:)        ! direction to move along each level
  integer,allocatable:: pos(:)          ! position along each of the axes
  integer            :: maxdim          ! dimensionality of entire space
  integer            :: vcnt            ! visitation count
...
contains 
  ...
  subroutine init_spacecurve_mod(I_SEopt)
    ...
    !-------------
    return
  end subroutine init_spacecurve_mod
  !==================================================================
