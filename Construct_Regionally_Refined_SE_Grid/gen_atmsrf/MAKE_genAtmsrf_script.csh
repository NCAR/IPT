...
##--------------------------------------------------------
  ...
  echo "  #   cheyenne% qcmd -- 'ncl gen_atmsrf_"$GRID_TAG".ncl >& LOG_"$GRID_TAG"'"
  echo "  # "
  echo "  #--------------------------------------------------------- "
  echo " "
  mkdir -p $GRID_NAME
  sed -e $SEDcmdR -e $SEDcmdG -e $SEDcmdS -e $SEDcmdL -e $SEDcmdD < ./TEMPLATES/gen_atmsrf_TEMPLATE.ncl >  ./$GRID_NAME/gen_atmsrf_$GRID_TAG.ncl 
