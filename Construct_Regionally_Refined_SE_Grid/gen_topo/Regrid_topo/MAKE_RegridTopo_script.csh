...
##--------------------------------------------------------
  ...
  echo "  #   cheyenne% qcmd -- 'ncl Regrid_topo_"$GRID_TAG".ncl >& LOG_"$GRID_TAG"'"
  echo "  # "
  echo "  #--------------------------------------------------------- "
  echo " "
  mkdir -p $GRID_NAME
  sed -e $SEDcmdR -e $SEDcmdG -e $SEDcmdS -e $SEDcmdL -e $SEDcmdD < ./TEMPLATES/Regrid_topo_TEMPLATE.ncl >  ./$GRID_NAME/Regrid_topo_$GRID_TAG.ncl 
