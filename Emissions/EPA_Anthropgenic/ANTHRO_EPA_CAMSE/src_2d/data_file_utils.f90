...
!---------------------------------------------------------------------
   ...
   use area_mapper,      only : map_kernel
   ...
   use camse_utils, only      : area_interp_init_camse
...
!---------------------------------------------------------------------
   ...
   elseif( is_EPA_SECTOR ) then not_EPA_a
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      do j = 1,nlat_src
        ...
        enddo
      enddo
   elseif( is_EPA_STACK ) then not_EPA_a
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
has_new_grid : &
   if( new_grid ) then
     grid_cnt = grid_cnt + 1
     d2mMap => grid_specs(grid_cnt)
     d2mMap%nlons = nlon_src
     d2mMap%nlats = nlat_src
     d2mMap%has_area_map  = has_area_map
     d2mMap%has_lon_shift = has_lon_shift
     d2mMap%reorder_lons  = reorder_lons
     d2mMap%reorder_lats  = reorder_lats
     grid_ndx = grid_cnt
     allocate( d2mMap%lon_2d(nlon_src,nlat_src), &
               d2mMap%xedge_2d(nlon_src+1,nlat_src+1), &
               d2mMap%xedge_2d_ij(nlon_src+1,nlat_src+1),stat=ierr )
     if( ierr /= 0 ) then
       write(*,*) 'data_file_init: Failed to allocate grid_lons; error = ',ierr
       stop 'allocate failed'
     endif
     allocate( d2mMap%lat_2d(nlon_src,nlat_src), &
               d2mMap%yedge_2d(nlon_src+1,nlat_src+1), &
               d2mMap%yedge_2d_ij(nlon_src+1,nlat_src+1),stat=ierr )
     if( ierr /= 0 ) then
       write(*,*) 'data_file_init: Failed to allocate grid_lats; error = ',ierr
       stop 'allocate failed'
     endif

     d2mMap%lon_2d(:,:) = src_lons_2d(:,:)
     d2mMap%lat_2d(:,:) = src_lats_2d(:,:)
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
         do j = 1,nlat_src-1
           ...
           do i = 1,nlon_src-1
             ip1 = i + 1
             quad_x(:) = (/ d2mMap%lon_2d(i,j),d2mMap%lon_2d(ip1,j), &
                            d2mMap%lon_2d(ip1,jp1),d2mMap%lon_2d(i,jp1) /)
             quad_y(:) = (/ d2mMap%lat_2d(i,j),d2mMap%lat_2d(ip1,j), &
                            d2mMap%lat_2d(ip1,jp1),d2mMap%lat_2d(i,jp1) /)
             call lm_2_xy( quad_x, quad_y, kernel, (/ .5,.5 /), xy )
             d2mMap%xedge_2d(ip1,jp1) = xy(1)
             d2mMap%yedge_2d(ip1,jp1) = xy(2)
           enddo
         enddo
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
         ...
         do i = 1,nlon_src-1
           ...
           quad_y(:) = (/ d2mMap%lat_2d(i,j),d2mMap%lat_2d(ip1,j), &
                          d2mMap%lat_2d(ip1,jp1),d2mMap%lat_2d(i,jp1) /)
           call lm_2_xy( quad_x, quad_y, kernel, (/ .5,-.5 /), xy )
           d2mMap%xedge_2d(ip1,j) = xy(1)
           d2mMap%yedge_2d(ip1,j) = xy(2)
         enddo
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!   upper edge
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
         ...
         do i = 1,nlon_src-1
           ...
           quad_y(:) = (/ d2mMap%lat_2d(i,j),d2mMap%lat_2d(ip1,j), &
                          d2mMap%lat_2d(ip1,jp1),d2mMap%lat_2d(i,jp1) /)
           call lm_2_xy( quad_x, quad_y, kernel, (/ .5,1.5 /), xy )
           d2mMap%xedge_2d(ip1,jp1+1) = xy(1)
           d2mMap%yedge_2d(ip1,jp1+1) = xy(2)
         enddo
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!   left edge
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
         ...
         do j = 1,nlat_src-1
           ...
           quad_y(:) = (/ d2mMap%lat_2d(i,j),d2mMap%lat_2d(ip1,j), &
                          d2mMap%lat_2d(ip1,jp1),d2mMap%lat_2d(i,jp1) /)
           call lm_2_xy( quad_x, quad_y, kernel, (/ -.5,.5 /), xy )
           d2mMap%xedge_2d(i,jp1) = xy(1)
           d2mMap%yedge_2d(i,jp1) = xy(2)
         enddo
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!   right edge
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
         ...
         do j = 1,nlat_src-1
           ...
           quad_y(:) = (/ d2mMap%lat_2d(i,j),d2mMap%lat_2d(ip1,j), &
                          d2mMap%lat_2d(ip1,jp1),d2mMap%lat_2d(i,jp1) /)
           call lm_2_xy( quad_x, quad_y, kernel, (/ 1.5,.5 /), xy )
           d2mMap%xedge_2d(ip1+1,jp1) = xy(1)
           d2mMap%yedge_2d(ip1+1,jp1) = xy(2)
         enddo
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
         ...
         quad_y(:) = (/ d2mMap%lat_2d(i,j),d2mMap%lat_2d(ip1,j), &
                        d2mMap%lat_2d(ip1,jp1),d2mMap%lat_2d(i,jp1) /)
         call lm_2_xy( quad_x, quad_y, kernel, (/ -.5,-.5 /), xy )
         d2mMap%xedge_2d(i,j) = xy(1)
         d2mMap%yedge_2d(i,j) = xy(2)
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!   lower, right corner
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
         i = nlon_src-1 ; ip1 = i + 1
         ...
         quad_y(:) = (/ d2mMap%lat_2d(i,j),d2mMap%lat_2d(ip1,j), &
                        d2mMap%lat_2d(ip1,jp1),d2mMap%lat_2d(i,jp1) /)
         call lm_2_xy( quad_x, quad_y, kernel, (/ 1.5,-.5 /), xy )
         d2mMap%xedge_2d(ip1+1,j) = xy(1)
         d2mMap%yedge_2d(ip1+1,j) = xy(2)
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!   upper, right corner
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
         i = nlon_src-1 ; ip1 = i + 1
         ...
         quad_y(:) = (/ d2mMap%lat_2d(i,j),d2mMap%lat_2d(ip1,j), &
                        d2mMap%lat_2d(ip1,jp1),d2mMap%lat_2d(i,jp1) /)
         call lm_2_xy( quad_x, quad_y, kernel, (/ 1.5,1.5 /), xy )
         d2mMap%xedge_2d(ip1+1,jp1+1) = xy(1)
         d2mMap%yedge_2d(ip1+1,jp1+1) = xy(2)
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!   upper, left corner
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
         i = 1 ; ip1 = i + 1
         ...
         quad_y(:) = (/ d2mMap%lat_2d(i,j),d2mMap%lat_2d(ip1,j), &
                        d2mMap%lat_2d(ip1,jp1),d2mMap%lat_2d(i,jp1) /)
         call lm_2_xy( quad_x, quad_y, kernel, (/ -.5,1.5 /), xy )
         d2mMap%xedge_2d(i,jp1+1) = xy(1)
         d2mMap%yedge_2d(i,jp1+1) = xy(2)
       else not_EPA_b
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
         do j = 0,nlat_src
           ...
           do i = 0,nlon_src
             ...
             d2mMap%xedge_2d(ip1,jp1) = real(d2,kind=8)
             d2mMap%yedge_2d(ip1,jp1) = real(d1,kind=8)
           enddo
         enddo
       endif not_EPA_b
       ...
       allocate( d2mMap%model_area_type(ide,jde),stat=astat )
       if( astat /= 0 ) then
         write(*,*) 'data_file_init; failed to allocate model_area_type: error = ',astat
         stop 'Alloc error'
       endif
       d2mMap%model_area_type(:,:)%has_data = .false.
       d2mMap%model_area_type(:,:)%active_dcell_cnt = 0
       d2mMap%model_area_type(:,:)%total_dcell_cnt  = 0
       d2mMap%model_area_type(:,:)%interior_dcell_cnt = 0
       d2mMap%model_area_type(:,:)%partial_dcell_cnt  = 0
!---------------------------------------------------------------------
...
!---------------------------------------------------------------------
       ...
       if( .not. mdlGrid%mdl_is_CAMSE ) then
         call area_interp_init( d2mMap, d2mMap%model_area_type, diag_level )
       else
         call area_interp_init_camse( proj, mdlGrid, d2mMap, d2mMap%model_area_type(:,1), diag_level )
       endif
     else is_area_map
       ierr = 0
       allocate( d2mMap%ax(ids:ide,jds:jde,0:1), &
                 d2mMap%by(ids:ide,jds:jde,0:1),stat=status )
       ierr = ierr + status
       allocate( d2mMap%ix(ids:ide,jds:jde,0:1), &
                 d2mMap%jy(ids:ide,jds:jde,0:1),stat=status )
       ierr = ierr + status
       if( ierr /= 0 ) then
...
slat_loop: do jl = 1,nlat_src-1
             ...
             do il = 1,nlon_src-1
               ...
               if( found ) then
                 d2mMap%ix(i,j,0) = il
                 d2mMap%jy(i,j,0) = jl
                 call set_wghts( quad_x, quad_y, kernel, xy, wghts ) 
                 d2mMap%ax(i,j,0:1) = wghts(2:1:-1)
                 d2mMap%by(i,j,0:1) = wghts(4:3:-1)
         ...
         enddo mlon_loop
       enddo mlat_loop
       write(*,*) 'data_file_init: # model cells outside data grid = ',count(d2mMap%jy(:,:,0) == 0)
       write(*,*) 'data_file_init: min x data cell = ',minval(d2mMap%ix(:,:,0),mask=d2mMap%jy(:,:,0)>0)
       write(*,*) 'data_file_init: max x data cell = ',maxval(d2mMap%ix(:,:,0),mask=d2mMap%jy(:,:,0)>0)
       write(*,*) 'data_file_init: min y data cell = ',minval(d2mMap%jy(:,:,0),mask=d2mMap%jy(:,:,0)>0)
       write(*,*) 'data_file_init: max y data cell = ',maxval(d2mMap%jy(:,:,0),mask=d2mMap%jy(:,:,0)>0)
     endif is_area_map
   endif has_new_grid
...
!---------------------------------------------------------------
      ...
      use mapper_types, only : grid_specs
...
!---------------------------------------------------------------
               select case( trim(wrk_string) )
                 case( 'MOLECULES/CM2/S','MOLECULES/CM^2/S','MOLECULES CM-2 S-1' )
                   con_fac(1) = 1. ; con_fac(2) = 1.
                 case( 'MOLES/S' )
                   con_fac(2) = avogadro ; con_fac(1) = con_fac(2)
                 case( 'G/S' )
                   con_fac(2) = avogadro ; con_fac(1) = con_fac(2)
                 case default
                   con_fac(1) = 1. ; con_fac(2) = 1.
